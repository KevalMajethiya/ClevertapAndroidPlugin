...
class Firebase_Service_PushTemplates(private val project: Project) {
    ...
    private var get_app_context:Boolean=false
    ...
    fun add_content() {
        ...
        for (i in documentText.indices) {
            ...
            if (line.contains("try ")) {
                sb
                    .append("\t\tPTLog.debug(\"Inside Push Templates\");")
                    .append("        //added by CleverTap Assistant")
                    .append("\n")
                //clevertap_object=true
            }
            // }
            if(get_app_context==false) {
                if (line.contains("try")) {
                    sb
           ...
           // if(clevertap_object==false) {
                if (line.contains("if (info.fromCleverTap) {")) {
                    sb
                        .append("\t\t\t\tif (Utils.isForPushTemplates(extras)) {")
                        //.append("        //added by CleverTap Assistant")
                        .append("\n")
                        .append("\t\t\t\t\tTemplateRenderer.createNotification(context, extras);")
                        .append("        //added by CleverTap Assistant")
                        .append("\n")
                        .append("\t\t\t\t}")
                       // .append("        //added by CleverTap Assistant")
                       ...
                       // .append("        //added by CleverTap Assistant")
                        .append("\n")
                        .append(("\t\t\t\t\tCleverTapAPI.createNotification(context, extras);"))
                       // .append("        //added by CleverTap Assistant")
                        .append("\n")
                        .append(("\t\t\t\t\t} "))
                       // .append("        //added by CleverTap Assistant")
