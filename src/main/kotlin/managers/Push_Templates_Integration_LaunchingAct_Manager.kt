...
class Push_Templates_Integration_LaunchingAct_Manager(private val project: Project)
{
...
//        }
    ...
    fun initiateclevertap() {
        ...
        for (i in documentText.indices) {
            ...
            {
                sb
                    .append("\tBoolean service_running = false;")
            ...
            {
                sb
                    .append("\t\tif(service_running==true) {\n")
                    .append("\t\t\tIntent intent = new Intent(getBaseContext(), pushtemplate_service.class);\n")
                    .append("\t\t\tstartService(intent);\n")
                    .append("\t\t}\n")
