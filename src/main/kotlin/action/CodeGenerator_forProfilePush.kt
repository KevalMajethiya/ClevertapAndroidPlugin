...
class CodeGenerator_forProfilePush(private val mClass: PsiClass, private val editor:Editor) {
    fun generate() {
      ...
      //JL // onCreateMethodBody?.add(elementFactory.createStatementFromText("callPushprofileMethod(UserProperties);",mClass))
        ...
        //JL  //  mClass.add(elementFactory.createMethodFromText("void callPushprofileMethod(HashMap<String, Object> userProperties){clevertapDefaultInstance.pushProfile(userProperties);}", mClass))
