...
class Push_Templates_Test_Manager(private val project: Project)
{
...
//        }
    ...
    fun start_service() {
        ...
        for (i in documentText.indices) {
            var line = documentText[i]
                ...
                if (line.contains("Boolean service_running = false")) {
    ...
    fun stop_service() {
        ...
        for (i in documentText.indices) {
            ...
            if (line.contains("Boolean service_running = true")) {
